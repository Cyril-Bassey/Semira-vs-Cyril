...
const AwardsSection = () => {
  return (
    <div className="bg-white text-center p-10 md:p-20 flex flex-col md:flex-row justify-around w-full">
      {/* Left Side: Text and Reviews */}
      <div className="w-full md:w-[40%] flex flex-col justify-center items-center">
        <h1 className="text-2xl md:text-3xl font-bold mb-4 w-full text-left">
          Lorem ipsum dolor
        </h1>
        ...
        {/* Review Scores */}
        <div className="flex flex-col md:flex-row justify-start w-full gap-4 md:gap-8 mb-8">
          {/* Clutch */}
